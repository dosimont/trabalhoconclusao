...
|------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+-----------|
| =MPI_Init=               | <r> init [default datatype]                                                                                                                       | ok        |
| =MPI_Finalize=           | <r> finalize (*not implemented in* =mpi_replay.c)=.                                                                                                   |           |
| =MPI_Comm_size=          | <r> =comm_size= <double>                                                                                                                            |           |
| =MPI_Comm_split=         | <r> =comm_split=                                                                                                                                    |           |
| =MPI_Comm_dup=           | <r> =comm_dup=                                                                                                                                      |           |
|------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+-----------|
| =MPI_Send=               | <r> send <dst> <volume> [datatype]                                                                                                                | ok        |
| =MPI_Isend=              | <r> isend <dst> <volume> [datatype]                                                                                                               | ok        |
| =MPI_Recv=               | <r> recv <src> <volume> [datatype]                                                                                                                | ok        |
| =MPI_Irecv=              | <r> irecv <src> <volume> [datatype]                                                                                                               | ok        |
|------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+-----------|
| =MPI_Test=               | <r> test                                                                                                                                          |           |
| =MPI_Wait=               | <r> wait                                                                                                                                          | ok        |
| =MPI_Waitall=            | <r> waitall                                                                                                                                       | ok        |
|------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+-----------|
| =MPI_Barrier=            | <r> barrier                                                                                                                                       |           |
| =MPI_Bcast=              | <r> bcast <volume> [root] [datatype]                                                                                                              | ok        |
| =MPI_Reduce=             | <r> reduce <vcomm> <vcomp> [root] [datatype]                                                                                                      | ok        |
| =MPI_Allreduce=          | <r> allreduce <vcomm> <vcomp> [datatype]                                                                                                          |           |
| =MPI_Alltoall=           | <r> alltoall <sendvolume> <recvvolume> [datatype send] [datatype recv]                                                                            |           |
...
| =MPI_Gather=             | <r> gather <sendvolume> <recvcounts> [send datatype] [recv datatype]                                                                              |           |
| =MPI_Gatherv=            | <r> gatherv <sendvolume> <recvcounts times communicator size> [send datatype] [recv datatype]                                                     |           |
| =MPI_Allgather=          | <r> allgather <sendvolume> <recvvolume> [send datatype] [recv datatype]                                                                           |           |
| =MPI_Allgatherv=         | <r> allgatherv <sendvolume> <recvvolume times communicator size> [send datatype] [recv datatype]                                                  |           |
| =MPI_Reduce_scatter=     | <r> reducescatter <recvcounts times communicator size> <vcomp> [datatype]                                                                         |           |
|------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+-----------|
| CPU burst              | <r> compute <volume>                                                                                                                              | ok        |
|------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+-----------|
