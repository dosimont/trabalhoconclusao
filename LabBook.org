...
| =MPI_Send=               | <r> send <dst> <volume>                                           | ok        |
| =MPI_Isend=              | <r> isend <dst> <volume>                                          | ok        |
| =MPI_Recv=               | <r> recv <src> <volume>                                           | ok        |
| =MPI_Irecv=              | <r> irecv <src> <volume>                                          | ok        |
|------------------------+-------------------------------------------------------------------+-----------|
| =MPI_Bcast=              | <r> bcast <volume>                                                |           |
| =MPI_Reduce=             | <r> reduce <vcomm> <vcomp>                                        |           |
| =MPI_Reduce_scatter=     | <r> reducescatter <recvcounts> <vcomp>                            |           |
| =MPI_Allreduce=          | <r> allreduce <vcomm> <vcomp>                                     |           |
| =MPI_Alltoall=           | <r> alltoall <sendvolume> <recvvolume>                            |           |
| =MPI_Alltoallv=          | <r> alltoallv <sendvolume> <sendcounts> <recvvolume> <recvcounts> |           |
| =MPI_Gather=             | <r> gather <sendvolume> <recvcounts>                              |           |
| =MPI_Allgatherv=         | <r> allgatherv <sendcount> <recvcounts>                           |           |
